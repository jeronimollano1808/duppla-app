...
const PAGES = { dashboard:<Dashboard/>, ventas:<Ventas/>, inventario:<Inventario/>, clientes:<Clientes/>, gastos:<Gastos/>, proveedores:<Proveedores/>, pedidos:<Pedidos/>, metas:<Metas/> };
...
export default function Layout({ user }) {
  ...
  return (
    <div style={{display:"flex",minHeight:"100vh",background:"#0f0f0f"}}>
      {/* Sidebar desktop */}
      <aside style={{width:220,background:"#141414",borderRight:"1px solid #1f1f1f",display:"flex",flexDirection:"column",position:"fixed",top:0,left:0,height:"100vh",zIndex:100,transition:"transform .25s"}}>
      ...
      <style>{`
        @media(max-width:768px){
          aside{transform:translateX(${menuOpen?'0':'-100%'})}
